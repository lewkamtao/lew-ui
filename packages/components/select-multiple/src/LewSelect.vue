...
const getClassName = computed(() => {
    let { size, align, clearable } = props;
    clearable = clearable ? (Boolean(v.value) ? true : false) : false;

    console.log(clearable);

    return getClass('lew-select', { size, align, clearable });
});
...
<template>
    ...
    >
        <template #trigger>
            <div ref="lewSelectRef" class="lew-select" :class="getClassName">
