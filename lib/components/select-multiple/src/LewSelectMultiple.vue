...
const getResultText = computed(() => {
    return state.options.length > 0
        ? locale.t('selectMultiple.resultCount', {
              num: numFormat(
                  state.options.filter((e: any) => !e.isGroup).length,
              ),
          })
        : ''
})
            ...
            >
                ...
                >
                    {{
                        placeholder
                            ? placeholder
                            : locale.t('selectMultiple.placeholder')
                    }}
                </div>
            </div>
        </template>
            ...
            >
                ...
                <div v-if="searchable" class="lew-search-input">
                    <input
                        ...
                        :placeholder="
                            locale.t('selectMultiple.searchPlaceholder')
                        "
                ...
                <div class="lew-select-options-box">
                    <template
                        v-if="state.options && state.options.length === 0"
                    >
                        ...
                        >
                            <lew-empty
                                :title="locale.t('selectMultiple.noResult')"
                            />
                        </lew-flex>
                    </template>
                                ...
                                >
                                    ...
                                    >
                                        <lew-checkbox
                                            ...
                                            :checked="
                                                getChecked(templateProps.value)
                                            "
                                        />
                                        <lew-text-trim
                                            :text="
    ...
    .lew-select-size {
        &-small {
            ...
            .lew-select-multiple-text-value {
                ...
                padding-right: 26px;
                line-height: calc(
                    var(--lew-form-item-height-small) -
        ...
        &-large {
            ...
            .lew-select-multiple-text-value {
                ...
                padding-right: 30px;
                line-height: calc(
                    var(--lew-form-item-height-large) -
                        (var(--lew-form-border-width) * 2)
                );
            }
        }
    ...
    .lew-search-input {
        ...
        input {
            ...
            border-bottom: var(--lew-form-border-width)
                var(--lew-form-bgcolor-hover) solid;
