...
import { treeSelectMultipleEmits } from './emits'
import { treeSelectMultipleProps } from './props'

const props = defineProps(treeSelectMultipleProps)
const emit = defineEmits(treeSelectMultipleEmits)
// 获取app
