...
const getPrefixesLabel = computed(() => {
    return (
        props.prefixesOptions.find((e) => e.value === prefixValue.value)
            ?.label || ''
    )
})
    ...
    >
        ...
        >
            <input
                ...
                :disabled="disabled"
                :placeholder="
                    placeholder ? placeholder : locale.t('input.placeholder')
                "
                :type="getType"
                :readonly="readonly"
                :maxlength="maxLength"
            ...
            <label
                v-if="autoWidth && clearable"
                class="lew-input-auto-width-clear"
            >
            </label>
            <div
