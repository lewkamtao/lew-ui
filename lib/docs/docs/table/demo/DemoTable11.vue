...
const data: any = ref([
    ...
    },
    {
        ...
        brand: 'Apple',
        category: 'Laptop',
        intro: 'Featuring M1 Pro or M1 Max chip, Liquid Retina XDR display, and ProMotion adaptive refresh rate technology.',
        price: 1599,
        stock: 500,
        color: 'Silver',
        storage: '1TB',
    ...
    },
    {
        ...
        brand: 'Microsoft',
        category: 'Laptop',
        intro: 'Powered by Intel Core or AMD Ryzen processors, features PixelSense touchscreen, supports Windows Hello facial recognition.',
        price: 1299,
        stock: 600,
        color: 'Platinum',
        storage: '512GB',
    ...
    },
    {
        ...
        brand: 'Apple',
        category: 'Tablet',
        intro: 'Powered by M1 chip, supports 5G network, features Liquid Retina XDR display with ProMotion technology.',
        price: 899,
        stock: 750,
        color: 'Space Gray',
        storage: '256GB',
