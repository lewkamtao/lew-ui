    ...
    components: {
        ...
        textTrim: {
            ...
            props: {
                ...
                delay: 'ツールチップの表示/非表示の遅延時間 [表示遅延, 非表示遅延]（ミリ秒）',
                reserveEnd:
        ...
        backTop: {
            ...
            props: {
                target: 'スクロールイベントをトリガーする対象要素（CSSセレクタ）。空の場合はウィンドウ全体',
                right: 'ページ右端からの距離（ピクセル）',
                bottom: 'ページ下端からの距離（ピクセル）',
                valveHeight:
                    'ボタンを表示するスクロール高さのしきい値（ピクセル）',
            },
            events: {
        ...
        menuTree: {
            ...
            menuTreeItem: {
                label: 'メニューツリー項目のタイトルテキスト。名前付きスロット "label" でカスタマイズ可能',
        ...
        inputTable: {
            ...
            props: {
                ...
                sortTooltipCustomRender:
                    'ソートツールチップのカスタムレンダリング',
            },
        },
        switch: {
            name: 'スイッチ Switch',
            description:
                'シンプルな切り替えコントロール、状態の変更をより明確に',
            demo1: {
                title: '基本的な使い方',
            },
            demo2: {
