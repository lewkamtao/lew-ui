...
export default {
    ...
    components: {
        ...
        backTop: {
            ...
            props: {
                target: '指定触发滚动事件的目标元素，使用 CSS 选择器。如果为空，则默认为整个窗口。',
        ...
        menuTree: {
            ...
            menuTreeItem: {
                label: '菜单树项的标题文本。也可以使用具名插槽 "label" 自定义标题内容。',
        ...
        input: {
            ...
            props: {
                ...
                prefixes: '输入框前缀类型',
                prefixesOptions:
                    '输入框前缀选项列表，当 prefixes 为 select 时使用',
