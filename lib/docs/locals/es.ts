...
export default {
    ...
    home: {
        title: 'Lew UI',
        description:
            'Una hermosa y fácil de usar biblioteca de componentes Vue3',
        getStarted: 'Comenzar',
    ...
    components: {
        ...
        textTrim: {
            ...
            props: {
                text: 'Contenido del texto',
                lineClamp:
                    'Número máximo de líneas a mostrar, el exceso será truncado',
        ...
        notification: {
            name: 'Notificación',
            description:
                'Notificaciones elegantes para un feedback más amigable.',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        dialog: {
            name: 'Diálogo (Dialog)',
            description:
                'Diálogo modal para resaltar interacciones importantes.',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        tooltip: {
            name: 'Tooltip',
            description:
                'Burbuja de texto simple para indicaciones más ligeras.',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
