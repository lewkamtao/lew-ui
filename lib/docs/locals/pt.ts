...
export default {
    ...
    home: {
        title: 'Lew UI',
        description:
            'Uma biblioteca de componentes Vue3 bonita e fácil de usar',
        getStarted: 'Começar',
    ...
    components: {
        ...
        button: {
            name: 'Botão',
            description:
                'Torne suas interações mais fluidas com um simples clique',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        title: {
            ...
            props: {
                ...
                color: 'Cor do texto do título, os valores opcionais incluem nomes de cores predefinidas ou valores de cor personalizados',
            },
        },
        textTrim: {
            name: 'Corte de texto TextTrim',
            description:
                'Trata textos longos com elegância, sem quebrar o layout',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
            ...
            props: {
                text: 'Conteúdo do texto',
                lineClamp:
                    'Número máximo de linhas a exibir, o excesso será truncado',
        ...
        icon: {
            name: 'Ícone Icon',
            description:
                'Coleção de ícones elegantes para enriquecer a interface',
        },
        backTop: {
        ...
        form: {
            ...
            props: {
                ...
                direction:
                    'Direção dos itens, "x" para horizontal, "y" para vertical',
        ...
        input: {
            ...
            props: {
                ...
                copyable:
                    'Permite copiar (apenas com readonly=true e suffix=false)',
        ...
        inputNumber: {
            ...
            description:
                'Campo específico para entrada de números com precisão',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        select: {
            name: 'Seletor Select',
            description:
                'Caixa de seleção suspensa para escolhas mais convenientes',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        selectMultiple: {
            ...
            description:
                'Caixa de seleção múltipla para escolhas mais flexíveis',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        dateRangePicker: {
            ...
            description:
                'Ferramenta para seleção conveniente de intervalos de datas',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        notification: {
            name: 'Notificação',
            description:
                'Notificações elegantes para um feedback mais amigável.',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
        ...
        modal: {
            name: 'Modal (Modal)',
            description:
                'Janela modal mais flexível para interações mais ricas',
            demo1: {
                title: 'Uso básico',
            },
            demo2: {
