...
export default {
    ...
    components: {
        ...
        tag: {
            name: '태그 Tag',
            description:
                '작지만 강력한 마킹 도구, 콘텐츠 분류에 색상과 스타일 추가',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        title: {
            ...
            props: {
                ...
                color: '제목 텍스트 색상, 미리 정의된 색상 이름 또는 사용자 정의 색상 값 사용 가능',
            },
        },
        textTrim: {
            ...
            props: {
                ...
                delay: '툴팁 표시 및 숨김 지연 시간 [표시 지연, 숨김 지연](단위: 밀리초)',
                reserveEnd:
        ...
        backTop: {
            ...
            props: {
                target: '스크롤 이벤트를 트리거할 대상 요소, CSS 선택자 사용. 비어 있으면 전체 창이 기본값.',
        ...
        menuTree: {
            name: '메뉴 트리 MenuTree',
            description:
                '계층이 명확한 트리형 메뉴, 복잡한 구조 관계를 쉽게 표시',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
            ...
            demo3: {
                title: '기본 펼침',
                description:
                    'v-model을 통해 기본적으로 펼쳐진 메뉴 항목을 제어합니다.',
            },
            demo4: {
                title: '태그',
            },
            ...
            menuTreeItem: {
                label: '메뉴 트리 항목의 제목 텍스트. "label" 이름이 지정된 슬롯을 사용하여 제목 내용을 사용자 정의할 수도 있습니다.',
        ...
        breadcrumb: {
            ...
            description:
                '명확한 경로 탐색, 사용자가 방향을 잃지 않도록 도와줍니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        actionBox: {
            name: '액션 박스',
            description:
                '유연한 작업 버튼으로 사용자가 빠르게 작업할 수 있습니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        form: {
            ...
            formItemProps: {
                ...
                labelWidth:
                    '개별 폼 항목 라벨 너비, 숫자(픽셀) 또는 "auto" 지원',
        ...
        input: {
            ...
            props: {
                ...
                suffix: '입력 상자 접미사 유형',
                suffixOptions:
                    '입력 상자 접미사 옵션 목록, suffix가 select일 때 사용',
        ...
        textarea: {
            ...
            props: {
                ...
                okByEnter:
                    '엔터 키로 확인 활성화 여부(활성화 시 Shift+Enter로 줄바꿈)',
            },
            events: {
                change: '값 변경 시 트리거',
                focus: '포커스 획득 시 트리거',
        ...
        dateRangePicker: {
            ...
            description:
                '시간 범위를 선택하는 도구로 구간 선택을 더 편리하게 합니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        switch: {
            name: '스위치 Switch',
            description:
                '간결한 스위치 선택기로 상태 전환을 더욱 명확하게 합니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        colorPicker: {
            ...
            description:
                '다양한 색상 선택 도구로 색상 선택을 더욱 정확하게 합니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        upload: {
            name: '업로드 Upload',
            description:
                '파일 업로드 컴포넌트로 파일 처리를 더욱 간편하게 합니다',
            demo1: {
                title: '일반',
            },
            demo2: {
        ...
        magicNumber: {
            ...
            description:
                '숫자 표시를 더욱 생동감 있게 만드는 애니메이션 컴포넌트',
        },
        tree: {
            name: '트리 Tree',
            description:
        ...
        alert: {
            name: '경고 Alert',
            description:
                '눈에 띄는 정보 알림 상자로, 경고를 더 부드럽게 표시합니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        notification: {
            ...
            description:
                '우아한 알림 메시지로 메시지 푸시를 더욱 친근하게 만듭니다.',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        popok: {
            name: '팝업 확인 상자 Popok',
            description:
                '경량 확인 프롬프트로, 작업 확인을 더 편리하게 만듭니다',
            demo1: {
                title: '기본 사용법',
            },
            demo2: {
        ...
        empty: {
            name: '빈 상태 Empty',
            description:
                '빈 데이터 상태 표시로, 빈 페이지를 더 친화적으로 만듭니다',
            demo1: {
                title: '기본 사용법',
            },
            props: {
