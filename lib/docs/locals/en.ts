    ...
    components: {
        ...
        title: {
            ...
            props: {
                ...
                color: 'Title Text Color, optional values include predefined color names or custom color values',
            },
        },
        textTrim: {
            name: 'Text Trim',
            ...
            props: {
                ...
                offset: 'Tooltip offset relative to the target element [x, y] (unit: pixel)',
                textAlign:
                    'Horizontal alignment direction (when width is less than container width)',
                delay: 'Delay time for showing and hiding the tooltip [show delay, hide delay] (unit: millisecond)',
                reserveEnd:
        ...
        mark: {
            name: 'Mark',
            description:
                'Add highlight marks to text, making key content stand out',
            demo1: {
                title: 'Basic Usage',
            },
            props: {
        ...
        backTop: {
            ...
            props: {
                target: 'Specify the target element to trigger the scroll event, using CSS selector. If empty, defaults to the entire window.',
                right: 'Set the distance of the component from the right side of the page, unit: pixel.',
                bottom: 'Set the distance of the component from the bottom of the page, unit: pixel.',
                valveHeight:
        ...
        menu: {
            name: 'Menu',
            description:
                'Elegant vertical menu, making navigation hierarchical',
            demo1: {
                title: 'Basic Usage',
            },
            model: {
        ...
        menuTree: {
            ...
            demo3: {
                ...
                description:
                    'Control the default expanded menu items through v-model.',
            },
            demo4: {
                title: 'Label',
            },
            ...
            model: {
                modelValue: 'Bound value of the current active menu',
                expandKeys:
                    'Array of key values of the default expanded menu items',
                collapsed: 'Collapse the menu',
            },
            props: {
                options:
                    'Data source of the menu tree, supporting nested structure.',
                width: 'Width of the menu tree, supporting CSS width values.',
            },
            menuTreeItem: {
                label: 'Title text of the menu tree item. You can also use the named slot "label" to customize the title content.',
                value: 'Value of the menu item, used to identify the uniqueness of the menu item.',
        ...
        breadcrumb: {
            name: 'Breadcrumb',
            description:
                'Clear path navigation, ensuring users do not get lost',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
        ...
        contextMenu: {
            name: 'Context Menu',
            description:
                'Elegant right-click menu, making operations more natural',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
        ...
        form: {
            ...
            props: {
                ...
                width: 'Overall width of the form, supporting numbers (pixels) or percentage strings',
                columns:
                    'Number of form items displayed per row, maximum value is 4',
                labelWidth:
            ...
            formItemProps: {
                ...
                field: 'Field name corresponding to the form item, used for data binding and validation',
                ...
                width: 'Width of a single form item, supporting numbers (pixels) or percentage strings',
                labelWidth:
                ...
                between:
                    'Add spacing between form items when arranged horizontally',
        ...
        input: {
            name: 'Input',
            description:
                'Feature-rich input box, making data entry more convenient',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
            ...
            props: {
                ...
                showCount:
                    'Show Character Count (only effective when type is text)',
        ...
        radio: {
            name: 'Radio',
            description:
                'Single-select selector, making single choice more clear',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
        ...
        switch: {
            name: 'Switch',
            description:
                'Simple switch selector, making state switching clearer',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
        ...
        table: {
            name: 'Table',
            description:
                'Powerful table component, making data display clearer',
            model: {
                modelValue: 'Parameter Name',
        ...
        pagination: {
            name: 'Pagination',
            description:
                'Clear pagination navigation, making data browsing easier',
            demo1: {
                title: 'Basic Usage',
            },
            demo2: {
        ...
        empty: {
            name: 'Empty',
            description:
                'Empty data state display, making blank pages more friendly',
            demo1: {
                title: 'Basic Usage',
            },
            props: {
