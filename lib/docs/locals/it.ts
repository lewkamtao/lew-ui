...
export default {
    ...
    home: {
        title: 'Lew UI',
        description:
            'Una libreria di componenti Vue 3 elegante e facile da usare',
    ...
    components: {
        ...
        textTrim: {
            ...
            props: {
                ...
                textAlign:
                    'Allineamento orizzontale (quando larghezza < contenitore)',
                delay: 'Ritardo [mostra, nascondi] tooltip in ms',
                reserveEnd:
                    'Caratteri da preservare alla fine (ellissi al centro)',
            },
        },
        flex: {
            name: 'Layout Flex',
        ...
        mark: {
            name: 'Evidenziatore',
            description:
                'Evidenzia il testo importante per una migliore visibilità',
            demo1: {
                title: 'Uso base',
            },
            props: {
        ...
        form: {
            name: 'Form',
            description:
                'Potente gestione dei form per una raccolta dati efficace',
            demo1: {
                title: 'Uso base',
            },
            demo2: {
        ...
        input: {
            name: 'Input',
            description:
                'Campo di input ricco di funzionalità per inserimento dati',
            demo1: {
                title: 'Uso base',
            },
            demo2: {
        ...
        inputTable: {
            ...
            props: {
                ...
                sortTooltipCustomRender:
                    'Rendering personalizzato tooltip ordinamento',
            },
        },
        switch: {
            name: 'Interruttore',
        ...
        sliderRange: {
            ...
            description:
                'Selezione intervalli di valori tramite cursore doppio',
            demo1: {
                title: 'Dimensioni',
            },
            demo2: {
        ...
        drawer: {
            name: 'Drawer',
            description:
                'Pannello a scorrimento laterale per operazioni temporanee.',
            demo1: {
                title: 'Uso base',
            },
            demo2: {
