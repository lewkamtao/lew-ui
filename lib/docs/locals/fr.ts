...
export default {
    ...
    components: {
        ...
        button: {
            name: 'Bouton',
            description:
                'Rendez vos interactions plus fluides avec un simple clic',
            demo1: {
                title: 'Utilisation de base',
            },
            demo2: {
        ...
        textTrim: {
            ...
            props: {
                text: 'Contenu du texte',
                lineClamp:
                    "Nombre maximum de lignes à afficher, l'excès sera tronqué",
        ...
        form: {
            ...
            formItemProps: {
                ...
                outputFormat:
                    'Méthode de formatage pour la sortie des paramètres',
                inputFormat:
                    "Méthode de formatage pour l'entrée des paramètres",
            },
            events: {
        ...
        input: {
            ...
            props: {
                ...
                autoWidth:
                    'Ajuster automatiquement la largeur en fonction du contenu',
                ...
                suffixTooltip:
                    "Texte d'info-bulle pour le suffixe du champ de saisie",
        ...
        treeSelect: {
            ...
            props: {
                ...
                loadMethod:
                    'Méthode de chargement asynchrone des nœuds enfants',
            },
            slots: {
                handle: 'Nom du slot',
            },
        ...
        actionBox: {
            name: "Boîte d'action",
            description:
                "Boutons d'action flexibles pour des opérations rapides",
            demo1: {
                title: 'Utilisation de base',
            },
            demo2: {
