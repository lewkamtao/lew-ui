...
export default {
    ...
    components: {
        ...
        flex: {
            name: 'Flex-Layout',
            description:
                'Flexibles Layout-System für mühelose Seitengestaltung',
            demo1: {
                title: 'Zeile',
            },
            demo2: {
        ...
        backTop: {
            ...
            props: {
                target: 'Zielelement für das Scroll-Event (CSS-Selektor). Standardmäßig das gesamte Fenster, wenn leer.',
        ...
        menuTree: {
            ...
            menuTreeItem: {
                label: 'Titel des Menübaum-Elements. Kann auch über den benannten Slot "label" angepasst werden',
        ...
        dropdown: {
            name: 'Dropdown-Menü',
            description:
                'Klickaktiviertes Schwebendes Menü für bequemere Bedienung',
            demo1: {
                title: 'Grundlegende Verwendung',
            },
            demo2: {
        ...
        form: {
            ...
            props: {
                ...
                width: 'Gesamtbreite des Formulars, unterstützt Zahlen (Pixel) oder Prozentangaben',
            ...
            formItemProps: {
                ...
                width: 'Breite des einzelnen Formularelements, unterstützt Zahlen (Pixel) oder Prozentangaben',
                labelWidth:
            ...
            events: {
                mounted:
                    'Wird ausgelöst, wenn das Formularelement eingebunden wird',
            },
            methods: {
        ...
        input: {
            name: 'Eingabefeld',
            description:
                'Funktionsreiches Eingabefeld für bequemere Dateneingabe',
            demo1: {
                title: 'Grundlegende Verwendung',
            },
            demo2: {
            ...
            props: {
                ...
                minWidth:
                    'Minimale Breite, unterstützt Zahlen (Pixel) oder Einheiten',
                autoWidth: 'Breite automatisch an Inhalt anpassen',
                selectByFocus: 'Gesamten Text bei Fokus auswählen',
                copyable:
                    'Kopieren erlauben (nur bei readonly=true und suffix=false)',
                prefixes: 'Präfix-Typ',
        ...
        textarea: {
            name: 'Textbereich',
            description:
                'Mehrzeiliges Eingabefeld für komfortablere Texteingabe',
            demo1: {
                title: 'Grundlegende Verwendung',
            },
            demo2: {
        ...
        radio: {
            name: 'Optionsfeld',
            description:
                'Einzelauswahl-Komponente für klare Auswahlmöglichkeiten',
            demo1: {
                title: 'Grundlegende Verwendung',
            },
            demo2: {
        ...
        sliderRange: {
            ...
            description:
                'Flexibler Schieberegler zur Auswahl von Wertebereichen',
            demo1: {
                title: 'Größe',
            },
            demo2: {
