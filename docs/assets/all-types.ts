...
export default {
  ...
  "LewBreadcrumbOptions": `export type LewBreadcrumbOptions = LewBreadcrumbOption[]`,
  ...
  "LewAvatarObjectFit": `export type LewAvatarObjectFit = 'fill' | 'contain' | 'cover' | 'none' | 'scale-down'`,
  "LewAvatarObjectPosition": `export type LewAvatarObjectPosition = 'center' | 'top' | 'bottom' | 'left' | 'right' | 'top left' | 'top right' | 'bottom left' | 'bottom right'`,
